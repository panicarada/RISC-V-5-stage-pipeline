...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../bd/CSSTE/ipshared/7ac8" \
       +incdir+"../../../../pipeline_stall.srcs/sources_1/bd/CSSTE/ipshared/7ac8" \
       +incdir+"../../../../pipeline_stall.srcs/sources_1/bd/CSSTE/ipshared/22f1/imports/Framework"
}
