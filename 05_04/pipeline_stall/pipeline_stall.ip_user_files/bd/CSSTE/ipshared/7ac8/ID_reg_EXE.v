...
module ID_reg_EXE (
    ...
    input [`REGS_WIDTH - 1 : 0] in_rs1_address,
    input [`REGS_WIDTH - 1 : 0] in_rs2_address,
    ...
    output reg [`REGS_WIDTH - 1 : 0] out_rs1_address,
    output reg [`REGS_WIDTH - 1 : 0] out_rs2_address,
    ...
    always @(posedge clk or posedge rst) begin
        if (rst) begin
            ...
            if (is_nop_ID_EXE) begin
                ...
                out_rs1_address <= in_rs1_address;
                out_rs2_address <= in_rs2_address;
