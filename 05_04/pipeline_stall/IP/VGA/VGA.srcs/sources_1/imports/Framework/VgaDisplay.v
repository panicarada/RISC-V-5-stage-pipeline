module VgaDisplay(
    ...
    initial $readmemh("C://panic//new//lab5//05_04//pipeline_stall//IP//VGA//vga_debugger.mem", display_data);
    ...
    initial $readmemh("C://panic//new//lab5//05_04//pipeline_stall//IP//VGA//font_8x16.mem", fonts_data);
